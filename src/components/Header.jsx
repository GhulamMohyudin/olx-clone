      ...
      <div className="container">
        <div className="row">
          <div className="col-md-12">
           <Link to="/"><img className="log-olx-small ms-4 mb-3 me-4 mt-2" src={"./images/olx.png"} alt="" /></Link>
  ...
  <button type="submit">
    <i className="fa fa-search" />
        ...
        {/* <button className="loginbtn">Login</button> */}
          <Link to="/sellform" > <div className="position  mb-3 "> <span className="span1" onClick={handleClicked}> 
